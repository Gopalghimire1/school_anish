            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'admission') echo 'nav-expanded nav-active';?>">
                        ...
                        <?php } if(is_superadmin_loggedin()){ ?>
                            <li class="<?php if ($sub_page == 'student/shuffle') echo 'nav-active';?>">
                                <a href="<?=base_url('student/shuffle')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('shuffle_roll')?></span>
                                </a>
                            </li>
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'classes' ||
                        ...
                        <ul class="nav nav-children">
                            ...
                            <?php if(get_permission('teacher_timetable', 'is_view')) { ?>
                            <!-- teacher timetable view -->
                            <li class="<?php if ($sub_page == 'timetable/lesson_planning') echo 'nav-active';?>">
                                <a href="<?=base_url('timetable/lesson_planning')?>">
                                    <span><i class="fas fa-chalkboard-teacher" aria-hidden="true"></i> <?=translate('lesson') . " " . translate('planning')?></span>
                                </a>
                            </li>
                            <?php } ?>
                    ...
                    <!-- assignments upload -->
                    <?php if(is_student_loggedin() || get_permission('attachment_type', 'is_view')) { ?>
                    <li class="nav-parent <?php if ($main_menu == 'assignments') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="icons icon-cloud-upload"></i><span><?=translate('assignments')?></span>
                        </a>
                        <ul class="nav nav-children">
                            <?php if(is_student_loggedin()) { ?>
                            <li class="<?php if ($sub_page == 'assignments/add') echo 'nav-active';?>">
                                <a href="<?=base_url('assignments/add')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('upload_assignment')?></span>
                                </a>
                            </li>
                            <?php } if(get_permission('attachment_type', 'is_view')) { ?>
                            <li class="<?php if ($sub_page == 'assignments/submit') echo 'nav-active';?>">
                                <a href="<?=base_url('assignments/submit')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('submit_assignment')?></span>
                                </a>
                            </li>
                            <?php } ?>
                        </ul>
                    ...
                    get_permission('exam_grade', 'is_view') || $teacher_privilege) {
                    ?>
                    <!-- exam master -->
                    <li class="nav-parent <?php if ($main_menu == 'exam' || $main_menu == 'mark' || $main_menu == 'exam_timetable' || $main_menu == 'teacher_privilege') echo 'nav-expanded nav-active';?>">
                        <a>
                        ...
                        <ul class="nav nav-children">
                            ...
                            get_permission('exam_term', 'is_view') ||
                            get_permission('mark_distribution', 'is_view') ||
                            get_permission('exam_hall', 'is_view') || $teacher_privilege) {
                            ?>
                            <?php if(get_permission('exam_timetable', 'is_view')) { ?>
                            <li class="nav-parent <?php if ($main_menu == 'teacher_privilege') echo 'nav-expanded nav-active';?>">
                                <a>
                                    <i class="icons icon-note"></i><span><?=translate('teacher_privilege')?></span>
                                </a>
                                <ul class="nav nav-children">
                                    <li class="<?php if ($sub_page == 'exam/teacher_privilege') echo 'nav-active';?>">
                                        <a href="<?=base_url('exam/teacher_privilege')?>">
                                             </i><?=translate('privilege_assign')?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'exam' || $main_menu == 'exam_term' || $main_menu == 'exam_hall') echo 'nav-expanded nav-active';?>">
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <?php } if (get_permission('exam', 'is_view') || $teacher_privilege) { ?>
                            ...
                            <?php } ?>
                            <?php
                            if(get_permission('exam_timetable', 'is_view') || $teacher_privilege) {
                            ?>
                            <!-- exam schedule -->
							<li class="nav-parent <?php if ($main_menu == 'exam_timetable') echo 'nav-expanded nav-active';?>">
                                ...
                                <ul class="nav nav-children">
                                    <?php if(get_permission('exam_timetable', 'is_view') || $teacher_privilege) { ?>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'mark') echo 'nav-expanded nav-active';?>">
                                ...
                                <ul class="nav nav-children">
                                    <?php if(get_permission('exam_mark', 'is_view') || $teacher_privilege) { ?>
                                    ...
                                    <?php } if(get_permission('exam_grade', 'is_view') || $teacher_privilege) { ?>
                    ...
                    ?>
                    <!-- test master -->
                    <li class="nav-parent <?php if ($main_menu == 'test' || $main_menu == 'test_mark') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="icons icon-book-open" aria-hidden="true"></i><span><?=translate('Test_master')?></span>
                        </a>
                        <ul class="nav nav-children">
                            <!-- test -->
                            <li class="nav-parent <?php if ($main_menu == 'test') echo 'nav-expanded nav-active';?>">
                                <a>
                                    <i class="fas fa-flask"></i> <span><?=translate('test')?></span>
                                </a>
                                <ul class="nav nav-children">
                                    <li class="<?php if ($sub_page == 'test/result') echo 'nav-active';?>">
                                        <a href="<?=base_url('test/result')?>">
                                            <span><?=translate('test_result')?></span>
                                        </a>
                                    </li>
                                    <li class="<?php if ($sub_page == 'test/test_category') echo 'nav-active';?>">
                                        <a href="<?=base_url('test/test_category')?>">
                                            <span><?=translate('test_category')?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <!-- marks -->
                            <li class="nav-parent <?php if ($main_menu == 'test_mark') echo 'nav-expanded nav-active';?>">
                                <a>
                                    <i class="fas fa-marker"></i><span><?=translate('marks')?></span>
                                </a>
                                <ul class="nav nav-children">
                                    <li class="<?php if ($sub_page == 'test/mark_entry') echo 'nav-active';?>">
                                        <a href="<?=base_url('test/mark_entry')?>">
                                            <span><?=translate('mark_entries')?></span>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'accounting') echo 'nav-expanded nav-active';?>">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <?php } if(get_permission('account', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'accounting/cash_generate_receipt') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('accounting/cash_generate_receipt'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('generate') . " " . translate('cash') . " " . translate('receipt'); ?></span>
                                </a>
                            </li>
                            <?php } if(get_permission('account', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'accounting/generate_bill') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('accounting/generate_bill'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('generate') . " " . translate('bill'); ?></span>
                                </a>
                            </li>
                            <?php } ?> 
                    ...
                    <?php } ?>
                    <?php if(get_permission('account', 'is_view')){ ?>
                    <li class="nav-parent <?php if ($sub_page == 'accounting/vendor' || $sub_page == 'accounting/stock' || $sub_page == 'accounting/stock_history' || $sub_page == 'accounting/item_category' || $sub_page == 'accounting/item') echo 'nav-expanded nav-active'; ?>">
                        <a><i class="fas fa-layer-group"></i><span><?php echo translate('inventory'); ?></span></a>
                        <ul class="nav nav-children">
                            <li class="<?php if ($sub_page == 'accounting/vendor') echo 'nav-active';?>">
                                <a href="<?=base_url('accounting/vendor')?>">
                                    <span><?php echo translate('vendor') ?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'accounting/stock') echo 'nav-active';?>">
                                <a href="<?=base_url('accounting/stock')?>">
                                    <span><?php echo translate('stock'); ?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'accounting/stock_history') echo 'nav-active';?>">
                                <a href="<?=base_url('accounting/stock_history')?>">
                                    <span><?php echo translate('stock_history'); ?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'accounting/item_category') echo 'nav-active';?>">
                                <a href="<?=base_url('accounting/item_category')?>">
                                    <span><?php echo translate('item') . " " . translate('category'); ?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'accounting/item') echo 'nav-active';?>">
                                <a href="<?=base_url('accounting/item')?>">
                                    <span><?php echo translate('item'); ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
