			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<div class="input-group">
						...
						<?php }	else{ ?>
							<input type="text" class="form-control col-md-4" id="nepaliDatepicker" autocomplete="off" name="daterange[0]" value='' /> &nbsp;&nbsp;&nbsp;&nbsp; to
							<input type="text" class="form-control col-md-4" id="nepaliDatepicker2" autocomplete="off" name="daterange[1]" value='' />
						<?php } ?>
					</div>
					<span class="error"></span>
				</div>
...
<script type="text/javascript">
	$(document).ready(function () {
    	...
    	$('.nepali-date-picker').css('z-index','99999');
