...
(function($) {
    $(document).ready(function(){
        ...
        if(screen_width > 1000){
            $('#nepali_calendar').html('<iframe src="https://www.hamropatro.com/widgets/calender-full.php"   frameborder="0" scrolling="no" marginwidth="0" marginheight="0" style="border:none; overflow:hidden; width:1201px; height:840px;" allowtransparency="true"></iframe>');
        }
        else if(screen_width < 201){
            $('#nepali_calendar').html('<iframe src="https://www.hamropatro.com/widgets/calender-small.php"  frameborder="0" scrolling="no" marginwidth="0" marginheight="0" style="border:none; overflow:hidden; width:200px; height:290px;" allowtransparency="true"></iframe>');
        }
        else{
            $('#nepali_calendar').html('<iframe src="https://www.hamropatro.com/widgets/calender-medium.php"  frameborder="0" scrolling="no" marginwidth="0" marginheight="0" style="border:none; overflow:hidden; width:295px; height:385px;" allowtransparency="true"></iframe>');
        }
    });
