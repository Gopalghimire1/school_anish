<header class="header">
	...
	<div class="header-right">
		...
		<?php } ?>
		    <li>
		        <button class="btn btn-sm <?= $this->session->userdata('date_type')==='ad'?'btn-info':'' ?>" id="date-AD" onclick="dateAD('<?=site_url()?>')">AD</button>
		        <button class="btn btn-sm <?= $this->session->userdata('date_type')==='bs'?'btn-info':'' ?>" id="date-BS" onclick="dateBS('<?=site_url()?>')">BS</button>
		    </li>
		...
		<div id="userbox" class="userbox">
			...
			<div class="dropdown-menu">
				<ul class="dropdown-user list-unstyled">
					...
					<?php endif; ?>
					<?php if(is_superadmin_loggedin() || is_accountant_loggedin() || is_librarian_loggedin()):?>
						<li role="separator" class="divider"></li>
						<li><a href="<?php echo base_url('settings/signature');?>"><i class="fas fa-school"></i> <?php echo translate('signature');?></a></li>
					<?php endif; ?>
					<li role="separator" class="divider"></li>
