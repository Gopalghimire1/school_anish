					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<div class="input-group">
								...
								<?php }	else{ ?>
									<input type="text" class="form-control col-md-4" id="nepaliDatepicker" autocomplete="off" name="daterange[]" value='' /> &nbsp;&nbsp;&nbsp;&nbsp; to
									<input type="text" class="form-control col-md-4" id="nepaliDatepicker2" autocomplete="off" name="daterange[]" value='' />
								<?php } ?>
							</div>
