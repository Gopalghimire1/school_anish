		...
		<div class="profile-head">
			...
			<div class="col-md-12 col-lg-5 col-xl-5">
				...
				<ul>
					...
					<li><div class="icon-holder" data-toggle="tooltip" data-original-title="<?=translate('mobile_no')?>"><i class="fas fa-phone-volume"></i></div> <?=(!empty($student['mobileno']) ? implode(',',json_decode($student['mobileno'])) : 'N/A'); ?></li>
					...
					<div class="panel-body">
							...
							<div class="col-md-3 mb-sm">
								<div class="form-group">
                                    ...
                                    <?php if($this->session->userdata('date_type') === 'bs'){
                                        $admission_date = explode('-',($student['admission_date']));
                                        $dateConvert = new DateConvert();
                                        $date = ($dateConvert->get_nepali_date($admission_date[0],$admission_date[1],$admission_date[2]));
                                        $student['admission_date'] = englishToNepali($date['y']).'/'.englishToNepali($date['m']).'/'.englishToNepali($date['d']);
                                        $birthday = explode('-',($student['birthday']));
                                        $dateConvert = new DateConvert();
                                        $date = ($dateConvert->get_nepali_date($birthday[0],$birthday[1],$birthday[2]));
                                        $student['birthday'] = englishToNepali($date['y']).'/'.englishToNepali($date['m']).'/'.englishToNepali($date['d']);
                                     ?>
                                        <input type="text" class="form-control" name="admission_date" id="nepaliDatepicker" value="<?=$student['admission_date']?>">
                						<?php }	else{ ?>
							...
							<div class="col-md-6 mb-sm">
								<div class="form-group">
									...
									<div class="input-group">
	                                    ...
	                                    <?php if($this->session->userdata('date_type') === 'bs'){ ?>
	                                        <input type="text" class="form-control" name="birthday" id="nepaliDatepicker2" value="<?=$student['birthday']?>">
	                                    <?php }	else{ ?>
						...
						<div class="row">
						    <?php if($student['mobileno']){
						        $mobileArray = json_decode($student['mobileno']);
							...
							<div class="col-md-3 mb-sm">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" name="mobileno[]" value="<?=set_value('mobileno', $mobile)?>" />
									</div>
						...
						<div class="row mb-md" id="student_login_details">
							<div class="col-md-4 mb-sm">
								<div class="form-group">
    						...
    						<div class="col-md-4 mb-sm">
    							<div class="form-group">
    								...
    								<div class="input-group">
    									...
    									<input type="password" class="form-control" name="password" value="<?=set_value('password', $student['password'])?>" />
    								</div>
