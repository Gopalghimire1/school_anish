		...
		<div class="profile-head social">
			...
			<div class="col-md-12 col-lg-5 col-xl-5">
				...
				<ul>
					...
					<li><div class="icon-holder" data-toggle="tooltip" data-original-title="<?=translate('mobile_no')?>"><i class="fas fa-phone"></i></div> <?=(!empty($staff['mobileno']) ? implode(',',(json_decode($staff['mobileno']))) : 'N/A'); ?></li>
...
<?php } ?>
								...
								<div class="row">
								    <?php 
								    if($staff['mobileno']){
								    $mobileArray = json_decode($staff['mobileno']);
								    foreach($mobileArray as $mobile){
								    ?>
									<div class="col-md-6 mb-sm">
										<div class="form-group">
											<label class="control-label"><?=translate('mobileno')?> <span class="required">*</span></label>
											<div class="input-group">
												<span class="input-group-addon"><i class="fas fa-phone-volume"></i></span>
												<input class="form-control" name="mobileno[]" type="number" value="<?=set_value('mobileno', $mobile)?>" />
											</div>
									...
									<div class="col-md-6 mb-sm">
										<div class="form-group">
											...
											<div class="input-group">
												<span class="input-group-addon"><i class="fas fa-phone-volume"></i></span>
												<input class="form-control" name="mobileno[]" type="number" />
											</div>
											<span class="error"><?php echo form_error('mobileno'); ?></span>
										</div>
									</div>
								...
								<div class="row mb-lg" id="staff_login_details">
        							<div class="col-md-4 mb-sm">
        								<div class="form-group">
        									<label class="control-label"><?=translate('username')?> <span class="required">*</span></label>
        									<div class="input-group">
        										<span class="input-group-addon"><i class="far fa-user"></i></span>
        										<input type="text" class="form-control" name="username" id="username" value="<?=set_value('username', $staff['username'])?>" />
        									</div>
...
$(document).on('click','#login_details',function(){
    ...
    let staff_login_cred = $('#staff_login_details');
    if(login_auth.is(':checked') === true){
        staff_login_cred.hide();
        staff_login_cred.prop('required','falstaffse');
    }
    else{
        staff_login_cred.show();
        staff_login_cred.prop('required','true');
    }
});
