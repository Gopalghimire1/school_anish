...
<?php } ?>
						...
						<div class="col-md-<?=$widget?> mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<?php }	else{ ?>
									    <input type="text" class="form-control" name="joining_date" id="nepaliDatepicker" >
									<?php } ?>
								</div>
						...
						<div class="col-md-4 mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<?php }	else{ ?>
									    <input class="form-control" name="birthday" autocomplete="off" id="nepaliDatepicker2">
									<?php } ?>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input class="form-control" name="mobileno[]" type="text" value="<?=set_value('mobileno')?>" autocomplete="off" />
								</div>
				    ...
				    <div class="row mb-lg" id="employee_login_details" <?php if(set_value('login_details') == true) echo 'style="display: none;"'; ?>>
						<div class="col-md-6 mb-sm">
							<div class="form-group">
...
<script>
    ...
    $(document).on('click','#login_details',function(){
        ...
        let employee_login_cred = $('#employee_login_details');
        if(login_auth.is(':checked') === true){
            employee_login_cred.hide();
            employee_login_cred.prop('required','false');
        }
        else{
            employee_login_cred.show();
            employee_login_cred.prop('required','true');
        }
    });
    $(document).on('click','#add_more_contact',function(){
        let html = `<div class="col-md-6 mb-sm">
						<div class="form-group">
