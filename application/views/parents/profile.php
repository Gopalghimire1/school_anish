		...
		<div class="profile-head social">
			...
			<div class="col-md-12 col-lg-5 col-xl-5">
				...
				<ul>
					...
					<li><div class="icon-holder" data-toggle="tooltip" data-original-title="<?=translate('mobile_no')?>"><i class="fas fa-phone"></i></div> <?=html_escape(empty($parent['mobileno']) ? 'N/A' : implode(',',json_decode($parent['mobileno'])));?></li>
...
<?php } ?>
					...
					<div class="row">
					    ...
					    <?php if($parent['mobileno']){ 
					    $mobileArray = json_decode($parent['mobileno']);
						...
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input class="form-control" name="mobileno" type="text" value="<?=set_value('mobileno', $mobile)?>" autocomplete="off" />
								</div>
					...
					<div class="row mb-lg" id="parent_login_details">
						<div class="col-md-4 mb-sm">
							<div class="form-group">
								<label class="control-label"><?=translate('username')?> <span class="required">*</span></label>
								<div class="input-group">
									<span class="input-group-addon"><i class="far fa-user"></i></span>
									<input type="text" class="form-control" name="username" id="username" value="<?=set_value('username', $parent['username'])?>" />
								</div>
...
$(document).on('click','#login_details',function(){
    ...
    let parent_login_cred = $('#parent_login_details');
    if(login_auth.is(':checked') === true){
        parent_login_cred.hide();
        parent_login_cred.prop('required','false');
    }
    else{
        parent_login_cred.show();
        parent_login_cred.prop('required','true');
    }
});
</script>
