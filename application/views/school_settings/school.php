            ...
            <?php echo form_open_multipart('school_settings' . get_request_url(), array('class' => 'form-horizontal  frm-submit-data')); ?>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label"><?=translate('branch_code')?> <span class="required">*</span></label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="branch_code" value="<?=$school['branch_code']?>" />
                            <span class="error"></span>
                        </div>
                    </div>
                    <div class="form-group">
