...
function dateAD(ajax_url){
   $('#date-AD').addClass('btn-info');
   $('#date-BS').removeClass('btn-info');
   console.log(ajax_url);
   $.ajax({
       url: ajax_url+'UpdateUser/updateDateType',
       data: {date_type: 'ad'},
       method: 'POST',
       success: function(data){
           if(data === '1'){
               location.reload();
                ...
                $('#date-BS').addClass('btn-info');
                $('#date-AD').removeClass('btn-info');
                alert('error');
           }
       }
   });
}
function dateBS(ajax_url){
   $('#date-BS').addClass('btn-info');
   $('#date-AD').removeClass('btn-info');
   console.log(ajax_url);
   $.ajax({
